...
在 [C 语言函数](../../c/guides/02-core-syntax/09-函数：代码复用的利器.md) 中，我们学习了函数定义、参数传递、返回值与递归。C++ 在此基础上增加了 **函数重载**、**默认参数**、**inline** 和 **函数模板**，使函数更加灵活强大。
...
> 详见 [C 第 09 篇](../../c/guides/02-core-syntax/09-函数：代码复用的利器.md)。
...
- [C 语言函数](../../c/guides/02-core-syntax/09-函数：代码复用的利器.md)
