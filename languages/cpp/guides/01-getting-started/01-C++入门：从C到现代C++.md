...
如果你已经学习了 [C 语言入门：为什么它是编程的基石](../../c/guides/01-getting-started/01-C语言入门：为什么它是编程的基石.md)，那么你已经掌握了变量、函数、指针这些编程世界的「砖块」。C++ 并不是一门全新的语言——它诞生于 C 语言之上，保留了 C 的高效与灵活，又在此基础上加入了面向对象、泛型编程等强大能力。
...
> 运算符、流程控制、循环等基础语法与 C 相同，详见 [C 语言核心语法](../../c/guides/02-core-syntax/)。本专栏后续章节将聚焦 C++ 独有的扩展。
...
- [C 语言入门：为什么它是编程的基石](../../c/guides/01-getting-started/01-C语言入门：为什么它是编程的基石.md)
- [C++ 教程首页](../../README.md)
